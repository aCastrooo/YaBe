...
<body>
	...
	<div style="color:#1a1a1a; 
			...
			margin-top: 15%;
			">
			<p style="font-family:Sans-serif; font-size:50px"><b>YaBe</b></p>
	...
	<div id="buttons" style="text-align:center;">
			...
			<a href="sortedItems	.jsp" style="text-decoration:none;">
				<button style="padding:10px; name:pcSearch;">General Search</button>
			</a>
	</div>
	<br>
	<br>
	<div id="buttons" style="text-align:center;">
		...
		<a href= "questions.jsp" style ="text-decoration:none;">
			<button style="padding:10px; name:question;">Post Question</button>
		</a>
		...
		<a href= "searchQuestions.jsp" style ="text-decoration:none;">
			<button style="padding:10px; name:searchQuestions;">Search Questions</button>
		</a>	
		<a href= "viewAuctions.jsp" style ="text-decoration:none;">
			<button style="padding:10px; name:searchQuestions;">View Past Auctions</button>
		</a>		
	</div>
</body>
</html>